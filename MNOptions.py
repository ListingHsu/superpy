...
# This is model parameters + constraints + chi2 from constraints + 33 sparticle/particle masses.                   
n_params =  n_dims + 2 * len(Likelihood.CMSSMConstraintTracker().constraint) + 33
